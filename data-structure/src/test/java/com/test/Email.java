...
public class Email {
    ...
    public  void testMessage() throws MessagingException {
        try {
            ...
            //设置用户名密码
            javaMailSender.setUsername("phxl-bd@hsms.com.cn");
            javaMailSender.setPassword("zVYJSd7awCMd8d4b");//密码
            ...
            //发送地址，及地址昵称
            mimeMessageHelper.setFrom("phxl-bd@hsms.com.cn", "phxl-bd@hsms.com.cn");
            //邮件标题
